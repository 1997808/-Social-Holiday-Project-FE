...
export const SearchUserForChat = ({ userId, name, username, profileImageId }) => {
  ...
  return (
    <div className="p-5 w-full h-auto flex bg-white rounded border-b border-solid border-gray-200">
